...
import {
    ...
    SiVisualstudiocode, SiVercel, SiDocker, SiMongodb, SiExpress
} from 'react-icons/si';
    ...
    return (
        <>
            <motion.h1
                ...
                className='font-serif text-5xl md:text-7xl text-extrabold text-white flex items-center justify-center mt-44'
                id="about"
            >
                About Me
            </motion.h1>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 text-white mx-4 md:mx-16 mt-24">
                ...
                <motion.div
                    ...
                    className="card h-auto md:h-[40rem] p-6 bg-gray-800 rounded-lg shadow-lg"
                >
                    <motion.h1
                        initial={{ opacity: 0, x: -50 }}
                        whileInView={{ opacity: 1, x: 0 }}
                        transition={{ duration: 0.8 }}
                        className='text-cyan-600 text-2xl md:text-3xl hover:text-cyan-900 mb-6 font-serif'
                    >
                        Who I Am ?
                    </motion.h1>
                    ...
                    <motion.h1
                        ...
                        className='text-2xl md:text-3xl text-extrabold font-mono mb-4'
                    >
                        My name is Avantika Sharma and I am a Full Stack Developer.
                    </motion.h1>
                    ...
                    <motion.p
                        ...
                        className='text-lg md:text-2xl text-bold text-gray-600 font-serif'
                    >
                        A passionate Full Stack Developer with 3 years of experience in web design and development.
                        Skilled in both front-end and back-end technologies, I specialize in building responsive,
                        scalable, and user-friendly web applications. Constantly expanding my expertise, I stay updated
                        with the latest technologies and practices to deliver optimal solutions. Proficient in React,
                        Django, Node.js, Docker and PostgreSQL, I focus on creating clean, maintainable code and
                    ...
                    >
                        <NavLink to="/resume">
                            ...
                            bg-opacity-80 text-[#f1f1f1] rounded-3xl hover:bg-opacity-70 transition font-semibold shadow-md mt-4">
                                RESUME
                            </button>
                        </NavLink>
                    </motion.div>
